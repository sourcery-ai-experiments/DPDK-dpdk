...
#define RTE_ETH_FOREACH_MATCHING_DEV(id, devargs, iter)                        \
  for (rte_eth_iterator_init(iter, devargs), id = rte_eth_iterator_next(iter); \
       id != RTE_MAX_ETHPORTS; id = rte_eth_iterator_next(iter))
...
#define RTE_ETH_LINK_SPEED_FIXED                                               \
  RTE_BIT32(0) /**< Disable autoneg (fixed speed) */
 ...
 */
#define RTE_ETH_LINK_HALF_DUPLEX                                               \
  0 /**< Half-duplex connection (see link_duplex). */
#define RTE_ETH_LINK_FULL_DUPLEX                                               \
  1                            /**< Full-duplex connection (see link_duplex). */
...
#define RTE_ETH_MQ_RX_RSS_FLAG                                                 \
  RTE_BIT32(0) /**< Enable RSS. @see rte_eth_rss_conf */
 ...
 * It is similar to RTE_ETH_RSS_PORT that they don't specify the specific type
 * of L4 header. This macro is defined to replace some specific L4
 ...
 *   RSS types.
 */
static inline uint64_t rte_eth_rss_hf_refine(uint64_t rss_hf) {
...
#define RTE_ETH_RSS_IPV6_PRE32 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE32)

#define RTE_ETH_RSS_IPV6_PRE40 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE40)

#define RTE_ETH_RSS_IPV6_PRE48 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE48)

#define RTE_ETH_RSS_IPV6_PRE56 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE56)

#define RTE_ETH_RSS_IPV6_PRE64 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE64)

#define RTE_ETH_RSS_IPV6_PRE96 (RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_PRE96)

#define RTE_ETH_RSS_IPV6_PRE32_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE32)

#define RTE_ETH_RSS_IPV6_PRE40_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE40)

#define RTE_ETH_RSS_IPV6_PRE48_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE48)

#define RTE_ETH_RSS_IPV6_PRE56_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE56)

#define RTE_ETH_RSS_IPV6_PRE64_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE64)

#define RTE_ETH_RSS_IPV6_PRE96_UDP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_PRE96)

#define RTE_ETH_RSS_IPV6_PRE32_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE32)

#define RTE_ETH_RSS_IPV6_PRE40_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE40)

#define RTE_ETH_RSS_IPV6_PRE48_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE48)

#define RTE_ETH_RSS_IPV6_PRE56_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE56)

#define RTE_ETH_RSS_IPV6_PRE64_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE64)

#define RTE_ETH_RSS_IPV6_PRE96_TCP                                             \
  (RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_PRE96)

#define RTE_ETH_RSS_IPV6_PRE32_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE32)

#define RTE_ETH_RSS_IPV6_PRE40_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE40)

#define RTE_ETH_RSS_IPV6_PRE48_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE48)

#define RTE_ETH_RSS_IPV6_PRE56_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE56)

#define RTE_ETH_RSS_IPV6_PRE64_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE64)

#define RTE_ETH_RSS_IPV6_PRE96_SCTP                                            \
  (RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_PRE96)
...
#define RTE_ETH_RSS_TUNNEL                                                     \
  (RTE_ETH_RSS_VXLAN | RTE_ETH_RSS_GENEVE | RTE_ETH_RSS_NVGRE)

#define RTE_ETH_RSS_VLAN (RTE_ETH_RSS_S_VLAN | RTE_ETH_RSS_C_VLAN)

/** Mask of valid RSS hash protocols */
#define RTE_ETH_RSS_PROTO_MASK                                                 \
  (RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_FRAG_IPV4 | RTE_ETH_RSS_NONFRAG_IPV4_TCP |   \
   RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_NONFRAG_IPV4_SCTP |              \
   RTE_ETH_RSS_NONFRAG_IPV4_OTHER | RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_FRAG_IPV6 | \
   RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_NONFRAG_IPV6_UDP |               \
   RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_NONFRAG_IPV6_OTHER |            \
   RTE_ETH_RSS_L2_PAYLOAD | RTE_ETH_RSS_IPV6_EX | RTE_ETH_RSS_IPV6_TCP_EX |    \
   RTE_ETH_RSS_IPV6_UDP_EX | RTE_ETH_RSS_PORT | RTE_ETH_RSS_VXLAN |            \
   RTE_ETH_RSS_GENEVE | RTE_ETH_RSS_NVGRE | RTE_ETH_RSS_MPLS)
...
#define RTE_ETH_VMDQ_MAX_VLAN_FILTERS                                          \
  64 /**< Maximum nb. of VMDq VLAN filters. */
...
#define RTE_ETH_NUM_RECEIVE_MAC_ADDR                                           \
  128 /**< Maximum nb. of receive mac addr. */
...
struct rte_eth_txmode {
  ...
  uint16_t pvid;
  __extension__ uint8_t /** If set, reject sending out tagged pkts */
...
struct rte_eth_rxseg_split {
   ...
   * for non-tunneling packets, the complete protocol sequence should be
   * defined. For tunneling packets, for simplicity, only the tunnel and inner
   * part of complete protocol sequence is required. If several protocol headers
   * are defined to split packets into multi-segments, the repeated parts of
   * adjacent segments should be omitted.
   */
  uint32_t proto_hdr;
};
...
struct rte_eth_hairpin_cap {
  ...
  struct rte_eth_hairpin_queue_cap
      rx_cap; /**< Rx hairpin queue capabilities. */
  struct rte_eth_hairpin_queue_cap
      tx_cap; /**< Tx hairpin queue capabilities. */
};
...
#define RTE_ETH_RX_OFFLOAD_VLAN                                                \
  (RTE_ETH_RX_OFFLOAD_VLAN_STRIP | RTE_ETH_RX_OFFLOAD_VLAN_FILTER |            \
   RTE_ETH_RX_OFFLOAD_VLAN_EXTEND | RTE_ETH_RX_OFFLOAD_QINQ_STRIP)
...
#define RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM                                    \
  RTE_BIT64(7) /**< Used for tunneling packet. */
#define RTE_ETH_TX_OFFLOAD_QINQ_INSERT RTE_BIT64(8)
#define RTE_ETH_TX_OFFLOAD_VXLAN_TNL_TSO                                       \
  RTE_BIT64(9) /**< Used for tunneling packet. */
#define RTE_ETH_TX_OFFLOAD_GRE_TNL_TSO                                         \
  RTE_BIT64(10) /**< Used for tunneling packet. */
#define RTE_ETH_TX_OFFLOAD_IPIP_TNL_TSO                                        \
  RTE_BIT64(11) /**< Used for tunneling packet. */
...
struct rte_eth_rxseg_capa {
  __extension__ uint32_t
      multi_pools : 1;            /**< Supports receiving to multiple pools.*/
...
#define RTE_ETH_VALID_PORTID_OR_RET(port_id)                                   \
  do {                                                                         \
    if (!rte_eth_dev_is_valid_port(port_id)) {                                 \
      RTE_ETHDEV_LOG_LINE(ERR, "Invalid port_id=%u", port_id);                 \
      return;                                                                  \
...
#define RTE_ETH_FOREACH_DEV_OF(port_id, parent)                                \
  for (port_id = rte_eth_find_next_of(0, parent); port_id < RTE_MAX_ETHPORTS;  \
 ...
 *        queues per port. Any RSS hash function set in
 * eth_conf->rss_conf.rss_hf must be within the flow_type_rss_offloads provided
 * by drivers via rte_eth_dev_info_get() API.
 *
 ...
 * port_id). It is used when multiple ports are aggregated into a single one.
 *
 ...
 * port_id). When multiple ports are aggregated into a single one, it allows to
 * choose which port to use for Tx via a queue.
 *
 ...
 * port. The first aggregated port is number 1 and so on. The maximum number is
 ...
 *   device status. At least RTE_ETH_LINK_MAX_STR_LEN bytes should be allocated
 * to store default link status text.
 * @param len
 ...
 * required. The value must be in the range [0, nb_tx_queue - 1] previously
 * supplied to rte_eth_dev_configure().
 * @param stat_idx
 ...
 */
void rte_eth_tx_buffer_count_callback(struct rte_mbuf **pkts, uint16_t unsent,
                                      void *userdata);
...
enum rte_eth_event_type {
   ...
   * path API (such as rte_eth_dev_configure/rte_eth_dev_stop...) until
   * receiving RTE_ETH_EVENT_RECOVERY_SUCCESS or RTE_ETH_EVENT_RECOVERY_FAILED
   * event. The PMD will set the data path pointers to dummy functions, and
   * re-set the data path pointers to non-dummy functions before reporting
   * RTE_ETH_EVENT_RECOVERY_SUCCESS event. It means that the application cannot
   * send or receive any packets during this period.
 ...
 *   - On failure, a negative value.
 */
int rte_eth_dev_rx_intr_ctl_q(uint16_t port_id, uint16_t queue_id, int epfd,
                              int op, void *data);
 ...
 * @return
 *   - (0) if successful.
 *   - (-ENOTSUP) if support for priority_flow_ctrl_queue_info_get does not
 * exist.
 *   - (-ENODEV) if *port_id* invalid.
 *   - (-EINVAL) if bad parameter.
 */
 ...
 */
__rte_experimental int rte_eth_recycle_rx_queue_info_get(
 ...
 * @b EXPERIMENTAL: this API may change, or be removed, without prior notice
 *
 * Initialize the ethdev congestion management configuration structure with
 * default values.
 *
 * @param port_id
 *   The port identifier of the Ethernet device.
 ...
 * @b EXPERIMENTAL: this API may change, or be removed, without prior notice
 *
 * Retrieve the applied ethdev congestion management parameters for the given
 * port.
 *
 * @param port_id
 *   The port identifier of the Ethernet device.
...
static inline uint16_t rte_eth_rx_burst(uint16_t port_id, uint16_t queue_id,
  ...
  if (port_id >= RTE_MAX_ETHPORTS || queue_id >= RTE_MAX_QUEUES_PER_PORT) {
    RTE_ETHDEV_LOG_LINE(ERR, "Invalid port_id=%u or queue_id=%u", port_id,
                        queue_id);
    return 0;
  }
#endif
  ...
  if (qd == NULL) {
    RTE_ETHDEV_LOG_LINE(ERR, "Invalid Rx queue_id=%u for port_id=%u", queue_id,
                        port_id);
    return 0;
  }
#endif
...
#ifdef RTE_ETHDEV_RXTX_CALLBACKS
  {
    ...
    if (unlikely(cb != NULL))
      nb_rx = rte_eth_call_rx_callbacks(port_id, queue_id, rx_pkts, nb_rx,
                                        nb_pkts, cb);
  }
#endif
 ...
 *   - (-ENOTSUP) if the device does not support this function
 */
static inline int rte_eth_rx_queue_count(uint16_t port_id, uint16_t queue_id) {
  struct rte_eth_fp_ops *p;
  void *qd;
 ...
 */
static inline int rte_eth_rx_descriptor_status(uint16_t port_id,
                                               uint16_t queue_id,
                                               uint16_t offset) {
  struct rte_eth_fp_ops *p;
  void *qd;
...
static inline uint16_t rte_eth_tx_burst(uint16_t port_id, uint16_t queue_id,
  ...
  if (qd == NULL) {
    RTE_ETHDEV_LOG_LINE(ERR, "Invalid Tx queue_id=%u for port_id=%u", queue_id,
                        port_id);
    return 0;
  }
#endif
...
static inline uint16_t rte_eth_tx_prepare(uint16_t port_id, uint16_t queue_id,
                                          struct rte_mbuf **tx_pkts,
                                          uint16_t nb_pkts) {
  struct rte_eth_fp_ops *p;
  void *qd;
...
rte_eth_tx_buffer_flush(uint16_t port_id, uint16_t queue_id,
  ...
  if (unlikely(sent != to_send))
    buffer->error_callback(&buffer->pkts[sent], (uint16_t)(to_send - sent),
 ...
 *     the rest.
 */
static __rte_always_inline uint16_t rte_eth_tx_buffer(
    uint16_t port_id, uint16_t queue_id, struct rte_eth_dev_tx_buffer *buffer,
 ...
 *
 * Currently, the rte_eth_recycle_mbufs() function can support to feed 1 Rx
 * queue from 2 Tx queues in the same thread. Do not pair the Rx queue and Tx
 * queue in different threads, in order to avoid memory error rewriting.
 *
 * @param rx_port_id
...
rte_eth_recycle_mbufs(uint16_t rx_port_id, uint16_t rx_queue_id,
  ...
  if (tx_port_id >= RTE_MAX_ETHPORTS ||
    ...
    RTE_ETHDEV_LOG_LINE(ERR, "Invalid tx_port_id=%u or tx_queue_id=%u",
 ...
 * queue_id. The caller must therefore ensure that the port is enabled and the
 * queue is configured and running.
 *
 * @param port_id
 *   The port identifier of the device.
 * @param queue_id
 ...
 * @return
 *   The number of used descriptors in the specific queue, or:
 *   - (-ENODEV) if *port_id* is invalid. Enabled only when RTE_ETHDEV_DEBUG_TX
 * is enabled.
 *   - (-EINVAL) if *queue_id* is invalid. Enabled only when RTE_ETHDEV_DEBUG_TX
 * is enabled.
 *   - (-ENOTSUP) if the device does not support this function.
 *
 ...
 */
__rte_experimental static inline int rte_eth_tx_queue_count(uint16_t port_id,
                                                            uint16_t queue_id) {
  ...
  if (queue_id >= RTE_MAX_QUEUES_PER_PORT) {
    RTE_ETHDEV_LOG_LINE(ERR, "Invalid queue_id=%u for port_id=%u", queue_id,
                        port_id);
    rc = -EINVAL;
    goto out;
  }

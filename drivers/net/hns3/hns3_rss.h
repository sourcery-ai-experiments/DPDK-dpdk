...
#define HNS3_RSS_SUPPORT_L3_SRC_DST                                            \
  (RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY)
#define HNS3_RSS_SUPPORT_L4_SRC_DST                                            \
  (RTE_ETH_RSS_L4_SRC_ONLY | RTE_ETH_RSS_L4_DST_ONLY)
#define HNS3_RSS_SUPPORT_L3L4                                                  \
  (HNS3_RSS_SUPPORT_L3_SRC_DST | HNS3_RSS_SUPPORT_L4_SRC_DST)

#define HNS3_RSS_SUPPORT_FLOW_TYPE                                             \
...
#define HNS3_ETH_RSS_SUPPORT                                                   \
  (HNS3_RSS_SUPPORT_FLOW_TYPE | HNS3_RSS_SUPPORT_L3L4)

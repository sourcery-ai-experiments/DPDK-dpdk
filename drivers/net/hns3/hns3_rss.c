...
static const struct {
  ...
  uint64_t tuple_mask;
    ...
    /* IPV4-FRAG */
    {RTE_ETH_RSS_FRAG_IPV4 | RTE_ETH_RSS_L3_SRC_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_FRAG_IP_S), HNS3_RSS_TUPLE_IPV4_FLAG_M},
    {RTE_ETH_RSS_FRAG_IPV4 | RTE_ETH_RSS_L3_DST_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_FRAG_IP_D), HNS3_RSS_TUPLE_IPV4_FLAG_M},
    {RTE_ETH_RSS_FRAG_IPV4, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_FRAG_IP_S) |
         BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_FRAG_IP_D),
     HNS3_RSS_TUPLE_IPV4_FLAG_M},

    /* IPV4 */
    {RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_L3_SRC_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_S), HNS3_RSS_TUPLE_IPV4_NONF_M},
    {RTE_ETH_RSS_IPV4 | RTE_ETH_RSS_L3_DST_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_D), HNS3_RSS_TUPLE_IPV4_NONF_M},
    {RTE_ETH_RSS_IPV4, HNS3_RSS_IP_TUPLE,
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_OTHER | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_S),
     HNS3_RSS_TUPLE_IPV4_NONF_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_OTHER | RTE_ETH_RSS_L3_DST_ONLY,
     HNS3_RSS_IP_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_D),
     HNS3_RSS_TUPLE_IPV4_NONF_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_OTHER, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_S) |
         BIT_ULL(HNS3_RSS_FIELD_IPV4_EN_NONFRAG_IP_D),
     HNS3_RSS_TUPLE_IPV4_NONF_M},
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_TCP | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_TCP_EN_IP_S),
     HNS3_RSS_TUPLE_IPV4_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_TCP | RTE_ETH_RSS_L3_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_TCP_EN_IP_D),
     HNS3_RSS_TUPLE_IPV4_TCP_M},
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_TCP | RTE_ETH_RSS_L4_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_TCP_EN_TCP_D),
     HNS3_RSS_TUPLE_IPV4_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_TCP, HNS3_RSS_IP_L4_TUPLE,
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_UDP_EN_IP_S),
    ...
    {RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_L4_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_UDP_EN_UDP_S),
     HNS3_RSS_TUPLE_IPV4_UDP_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_UDP | RTE_ETH_RSS_L4_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV4_UDP_EN_UDP_D),
     HNS3_RSS_TUPLE_IPV4_UDP_M},
    {RTE_ETH_RSS_NONFRAG_IPV4_UDP, HNS3_RSS_IP_L4_TUPLE,
    ...
    /* IPV6-FRAG */
    {RTE_ETH_RSS_FRAG_IPV6 | RTE_ETH_RSS_L3_SRC_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_FRAG_IP_S), HNS3_RSS_TUPLE_IPV6_FLAG_M},
    {RTE_ETH_RSS_FRAG_IPV6 | RTE_ETH_RSS_L3_DST_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_FRAG_IP_D), HNS3_RSS_TUPLE_IPV6_FLAG_M},
    {RTE_ETH_RSS_FRAG_IPV6, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_FRAG_IP_S) |
         BIT_ULL(HNS3_RSS_FIELD_IPV6_FRAG_IP_D),
     HNS3_RSS_TUPLE_IPV6_FLAG_M},

    /* IPV6 */
    {RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_SRC_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_S), HNS3_RSS_TUPLE_IPV6_NONF_M},
    {RTE_ETH_RSS_IPV6 | RTE_ETH_RSS_L3_DST_ONLY, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_D), HNS3_RSS_TUPLE_IPV6_NONF_M},
    {RTE_ETH_RSS_IPV6, HNS3_RSS_IP_TUPLE,
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_OTHER | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_S),
     HNS3_RSS_TUPLE_IPV6_NONF_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_OTHER | RTE_ETH_RSS_L3_DST_ONLY,
     HNS3_RSS_IP_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_D),
     HNS3_RSS_TUPLE_IPV6_NONF_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_OTHER, HNS3_RSS_IP_TUPLE,
     BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_S) |
         BIT_ULL(HNS3_RSS_FIELD_IPV6_NONFRAG_IP_D),
     HNS3_RSS_TUPLE_IPV6_NONF_M},
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_TCP_EN_IP_S),
     HNS3_RSS_TUPLE_IPV6_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L3_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_TCP_EN_IP_D),
     HNS3_RSS_TUPLE_IPV6_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L4_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_TCP_EN_TCP_S),
     HNS3_RSS_TUPLE_IPV6_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_TCP | RTE_ETH_RSS_L4_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_TCP_EN_TCP_D),
     HNS3_RSS_TUPLE_IPV6_TCP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_TCP, HNS3_RSS_IP_L4_TUPLE,
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L3_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_UDP_EN_IP_D),
     HNS3_RSS_TUPLE_IPV6_UDP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L4_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_UDP_EN_UDP_S),
     HNS3_RSS_TUPLE_IPV6_UDP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_UDP | RTE_ETH_RSS_L4_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_UDP_EN_UDP_D),
     HNS3_RSS_TUPLE_IPV6_UDP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_UDP, HNS3_RSS_IP_L4_TUPLE,
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L3_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_SCTP_EN_IP_S),
    ...
    {RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L4_SRC_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_SCTP_EN_SCTP_S),
     HNS3_RSS_TUPLE_IPV6_SCTP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_SCTP | RTE_ETH_RSS_L4_DST_ONLY,
     HNS3_RSS_IP_L4_TUPLE, BIT_ULL(HNS3_RSS_FIELD_IPV6_SCTP_EN_SCTP_D),
     HNS3_RSS_TUPLE_IPV6_SCTP_M},
    {RTE_ETH_RSS_NONFRAG_IPV6_SCTP, HNS3_RSS_IP_L4_TUPLE,
 ...
 */
static int hns3_rss_set_algo_key(struct hns3_hw *hw, uint8_t hash_algo,
  ...
  for (idx = 0; idx < max_bd_num; idx++) {
    hns3_cmd_setup_basic_desc(&desc, HNS3_OPC_RSS_GENERIC_CONFIG, false);

    req->hash_config |= (hash_algo & HNS3_RSS_HASH_ALGO_MASK);
    req->hash_config |= (idx << HNS3_RSS_HASH_KEY_OFFSET_B);

    if (idx == max_bd_num - 1 && (key_len % HNS3_RSS_HASH_KEY_NUM) != 0)
...
static int hns3_rss_get_algo_key(struct hns3_hw *hw, uint8_t *hash_algo,
  ...
  max_bd_num = DIV_ROUND_UP(key_len, HNS3_RSS_HASH_KEY_NUM);
  for (idx = 0; idx < max_bd_num; idx++) {
    hns3_cmd_setup_basic_desc(&desc, HNS3_OPC_RSS_GENERIC_CONFIG, true);
...
int hns3_set_rss_indir_table(struct hns3_hw *hw, uint16_t *indir,
  ...
  for (i = 0; i < max_bd_num; i++) {
    ...
    req->start_table_index = rte_cpu_to_le_16(i * HNS3_RSS_CFG_TBL_SIZE);
    ...
    for (j = 0; j < cfg_tbl_size; j++) {
      ...
      qid_msb_off = j * HNS3_RSS_CFG_TBL_BW_H / HNS3_BITS_PER_BYTE;
    ...
    ret = hns3_cmd_send(hw, &desc, 1);
    if (ret) {
      hns3_err(hw, "Sets RSS indirection table failed %d size %u", ret, size);
      return ret;
    }
  }
...
static int hns3_get_rss_indir_table(struct hns3_hw *hw, uint16_t *indir,
                                    uint16_t size) {
  struct hns3_rss_indirection_table_cmd *req;
  uint16_t max_bd_num, cfg_tbl_size;
  ...
  max_bd_num = DIV_ROUND_UP(size, HNS3_RSS_CFG_TBL_SIZE);
  for (i = 0; i < max_bd_num; i++) {
    hns3_cmd_setup_basic_desc(&desc, HNS3_OPC_RSS_INDIR_TABLE, true);
    req->start_table_index = rte_cpu_to_le_16(i * HNS3_RSS_CFG_TBL_SIZE);
    ret = hns3_cmd_send(hw, &desc, 1);
    if (ret) {
    ...
    for (j = 0; j < cfg_tbl_size; j++) {
      qid_msb_idx = j * HNS3_RSS_CFG_TBL_BW_H / HNS3_BITS_PER_BYTE;
      rss_result_h = req->rss_result_h[qid_msb_idx];
      qid_msb_off = j * HNS3_RSS_CFG_TBL_BW_H % HNS3_BITS_PER_BYTE;
      q_hi = (rss_result_h >> qid_msb_off) & HNS3_RSS_CFG_TBL_BW_H_M;
...
int hns3_rss_reset_indir_table(struct hns3_hw *hw) {
  ...
  lut = rte_zmalloc("hns3_rss_lut", hw->rss_ind_tbl_size * sizeof(uint16_t), 0);
  if (lut == NULL) {
...
bool hns3_check_rss_types_valid(struct hns3_hw *hw, uint64_t types) {
  ...
  uint64_t ip_l4_mask =
      ...
      RTE_ETH_RSS_NONFRAG_IPV4_SCTP | RTE_ETH_RSS_NONFRAG_IPV6_TCP |
  ...
  if ((types & HNS3_ETH_RSS_SUPPORT) == 0) {
    hns3_err(hw, "specified types(0x%" PRIx64 ") are unsupported.", types);
    return false;
  }

  if ((types & HNS3_RSS_SUPPORT_L3_SRC_DST) != 0 &&
      (types & HNS3_RSS_SUPPORT_FLOW_TYPE) == 0) {
    hns3_err(hw, "IP or IP-TCP/UDP/SCTP packet type isn't specified, "
                 "L3_SRC/DST_ONLY cannot be set.");
    return false;
  }

  if (has_l4_src_dst && (types & ip_l4_mask) == 0) {
    if (!has_ip_pkt) {
      hns3_err(hw, "IP-TCP/UDP/SCTP packet type isn't specified, "
                   "L4_SRC/DST_ONLY cannot be set.");
      return false;
    }
    /*
     ...
     */
    hns3_warn(hw,
              "L4_SRC/DST_ONLY is ignored because of no including L4 packet.");
  }

  if ((types & ~HNS3_ETH_RSS_SUPPORT) != 0) {
    final_types = types & HNS3_ETH_RSS_SUPPORT;
    hns3_warn(hw,
              "set RSS types based on hardware support, requested:0x%" PRIx64
              " configured:0x%" PRIx64 "",
              types, final_types);
  }
...
uint64_t hns3_rss_calc_tuple_filed(uint64_t rss_hf) {
  uint64_t l3_only_mask = RTE_ETH_RSS_L3_SRC_ONLY | RTE_ETH_RSS_L3_DST_ONLY;
  uint64_t l4_only_mask = RTE_ETH_RSS_L4_SRC_ONLY | RTE_ETH_RSS_L4_DST_ONLY;
  ...
  for (i = 0; i < RTE_DIM(hns3_set_tuple_table); i++) {
    ...
    if (hns3_set_tuple_table[i].tuple_type == HNS3_RSS_IP_TUPLE) {
      if (hns3_set_tuple_table[i].rss_types & l3_only_mask || !has_l3_only)
        tuple |= hns3_set_tuple_table[i].rss_field;
      continue;
    }

    /* For IP types with L4, we need check both L3 and L4 */
    if (hns3_set_tuple_table[i].rss_types & l3_l4_only_mask || !has_l3_l4_only)
      tuple |= hns3_set_tuple_table[i].rss_field;
  }
...
int hns3_set_rss_tuple_by_rss_hf(struct hns3_hw *hw, uint64_t rss_hf) {
  ...
  if (ret != 0)
    hns3_err(hw, "Update RSS flow types tuples failed, ret = %d", ret);
...
int hns3_dev_rss_hash_update(struct rte_eth_dev *dev,
  ...
  if (key && key_len != hw->rss_key_size) {
    hns3_err(hw, "the hash key len(%u) is invalid, must be %u", key_len,
             hw->rss_key_size);
    return -EINVAL;
  }
...
static uint64_t hns3_rss_tuple_fields_to_rss_hf(struct hns3_hw *hw,
                                                uint64_t tuple_fields) {
  uint64_t ipv6_sctp_l4_mask = BIT_ULL(HNS3_RSS_FIELD_IPV6_SCTP_EN_SCTP_D) |
                               BIT_ULL(HNS3_RSS_FIELD_IPV6_SCTP_EN_SCTP_S);
  uint64_t rss_hf = 0;
  uint64_t tuple_mask;
  uint32_t i;
  ...
  for (i = 0; i < RTE_DIM(hns3_set_tuple_table); i++) {
     ...
     */
    if ((hns3_set_tuple_table[i].rss_types & RTE_ETH_RSS_NONFRAG_IPV6_SCTP) &&
    ...
    if ((tuple_fields & tuple_mask) == tuple_mask) {
      ...
      if ((tuple_fields & hns3_set_tuple_table[i].rss_field) != tuple_mask)
        continue;
...
static int hns3_rss_hash_get_rss_hf(struct hns3_hw *hw, uint64_t *rss_hf) {
  uint64_t tuple_fields;
  int ret;
...
int hns3_dev_rss_reta_update(struct rte_eth_dev *dev,
  ...
  if (reta_size != hw->rss_ind_tbl_size) {
    hns3_err(hw,
             "The size of hash lookup table configured (%u)"
             "doesn't match the number hardware can supported"
             "(%u)",
             reta_size, hw->rss_ind_tbl_size);
    return -EINVAL;
  }
  rte_spinlock_lock(&hw->lock);
  ...
  for (i = 0; i < reta_size; i++) {
    ...
    if (reta_conf[idx].reta[shift] >= hw->alloc_rss_size) {
      hns3_err(hw,
               ...
               reta_conf[idx].reta[shift], hw->alloc_rss_size);
      ret = -EINVAL;
      goto out;
    }
  ...
  ret = hns3_set_rss_indir_table(hw, indirection_tbl, hw->rss_ind_tbl_size);
  if (ret != 0)
    goto out;
...
int hns3_dev_rss_reta_query(struct rte_eth_dev *dev,
  ...
  if (ret != 0) {
    rte_spinlock_unlock(&hw->lock);
    hns3_err(hw, "query RSS redirection table failed, ret = %d.", ret);
    return ret;
  }
  rte_spinlock_unlock(&hw->lock);
...
static void hns3_set_rss_tc_mode_entry(struct hns3_hw *hw, uint8_t *tc_valid,
  ...
  for (i = 0; i < tc_num; i++) {
    if (hns->is_vf) {
       ...
       */
      tc_valid[i] = (hw->hw_tc_map & BIT(i)) ? !!(hw->hw_tc_map & BIT(i)) : 1;
      tc_size[i] = roundup_size;
      tc_offset[i] = (hw->hw_tc_map & BIT(i)) ? rss_size * i : 0;
    } else {
...
static int hns3_set_rss_tc_mode(struct hns3_hw *hw) {
  ...
  for (i = 0; i < HNS3_MAX_TC_NUM; i++) {
    ...
    hns3_set_field(mode, HNS3_RSS_TC_SIZE_M, HNS3_RSS_TC_SIZE_S, tc_size[i]);
 ...
 */
int hns3_update_rss_algo_key(struct hns3_hw *hw, uint8_t hash_func,
                             uint8_t *key, uint8_t key_len) {
  uint8_t rss_key[HNS3_RSS_KEY_SIZE_MAX] = {0};
  ...
  ret = hns3_rss_get_algo_key(hw, &hash_algo, rss_key, hw->rss_key_size);
  if (ret != 0) {
    hns3_err(hw, "fail to get RSS hash algorithm and key, ret = %d", ret);
    return ret;
  }
  ...
  if (ret != 0)
    hns3_err(hw, "fail to set RSS hash algorithm and key, ret = %d", ret);
...
int hns3_config_rss(struct hns3_adapter *hns) {
  ...
  ret =
      hns3_rss_set_algo_key(hw, rss_cfg->hash_algo, hash_key, hw->rss_key_size);
  if (ret)
    return ret;

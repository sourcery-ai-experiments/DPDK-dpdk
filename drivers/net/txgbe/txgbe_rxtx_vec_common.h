...
static inline uint16_t reassemble_packets(struct txgbe_rx_queue *rxq,
...
static __rte_always_inline void tx_backlog_entry(struct txgbe_tx_entry_v *txep,
...
static inline void _txgbe_tx_free_swring_vec(struct txgbe_tx_queue *txq) {
  if (txq == NULL)
    return;
...
static inline void _txgbe_reset_tx_queue_vec(struct txgbe_tx_queue *txq) {
...
static inline int txgbe_rxq_vec_setup_default(struct txgbe_rx_queue *rxq) {
  uintptr_t p;
